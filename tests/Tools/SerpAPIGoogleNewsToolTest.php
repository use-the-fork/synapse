...
declare(strict_types=1);
    ...
    expect($agentResponseArray['content'])->toBeArray()
        ...
        ->and($agentResponseArray['content']['answer'])->toContain("Current headlines about Apple include news about potential discontinuation of some products, sales predictions for the iPhone 16 series based on Apple Intelligence");
